...
for (loop in 1:length(supply_seed)){
  ...
  a = 300 #parameter in search cost sc= a * EZ^2 * s_k
  b = 50
  K = 1:K_
  I = 1:I_
...
ggsave("TS1_LowSC_Candle.pdf", width = 11.69, height = 8.27, units = "in")
...
ggsave("TS1_LowSC_Encounter.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_LowSC_Jump_All.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_LowSC_Jump_1.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_LowSC_Jump_2.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_LowSC_Jump_3.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_LowSC_Unsatisfied_Demand.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_LowSC_Excess_Demand.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_LowSC_Excess_Demand_All.pdf", width = 8, height = 6, units = "in")
