...
#ggsave("TS1_Base_Candle.pdf", width = 11.69, height = 8.27, units = "in")
...
ggplot(candle_chart_df)+
  ...
  scale_x_discrete(labels= seq(0, length(supply_seed) - 10, 10),
                   breaks = seq(0, length(supply_seed) - 10, 10))+
  scale_y_continuous(labels = c(70, 90,110),
                     breaks = c(70, 90,110))+
  scale_color_manual(name = "Legend",
...
#ggsave("TS1_Base_Encounter.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_Base_Jump_All.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_Base_Jump_1.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_Base_Jump_2.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_Base_Jump_3.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_Base_Unsatisfied_Demand.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_Base_Excess_Demand.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_Base_Excess_Demand_All.pdf", width = 8, height = 6, units = "in")
...
# 
# ggplot(candle_chart_df)+
#   geom_point(aes(x = ts, y = price_close), color = "green", size = .5)+
#   geom_line(aes(x = as.numeric(ts), y = price_close), 
#             color= "green", linetype = "dashed")+
#   geom_point(data = candle_chart_df[oo1$ind,],  
#              aes(x = ts, y = price_close), color = 'red',
...
ggplot(candle_chart_df)+
  geom_point(aes(x = ts, y = price_close, color = "1")) +
  geom_line(aes(x = as.numeric(ts), y = price_close, color = "1"))+
  geom_point(aes(x = ts, y = price_equil, color = "2")) +
  geom_line(aes(x = as.numeric(ts), y = price_equil, color = "2"), linetype = "dashed")+
  scale_color_manual(name = "Legend",
                     values = c("green", "blue"),
                     labels = c("Closing Price",
                                "Equilbrium Price"
                     ))+
  scale_x_discrete(labels= seq(0, length(supply_seed) - 10, 10),
                   breaks = seq(0, length(supply_seed) - 10, 10))+
  geom_point(data = candle_chart_df[oo$ind,],  
                      aes(x = ts, y = price_close), color = 'red',
                       size = .7, shape = 3, stroke = 1.5)+
  # scale_y_continuous(labels = c("20%", "40%", "60%"),
  #                    breaks = c(20, 40, 60))+
  xlab("Trading Session")+
  ylab("Price")+
...
#ggsave("TS1_Base_Closing_Jump.pdf", width = 8, height = 6, units = "in")
