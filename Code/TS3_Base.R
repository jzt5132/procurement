...
ggsave("TS3_Base_Candle.pdf", width = 11.69, height = 8.27, units = "in")
...
ggsave("TS3_Base_Encounter.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS3_Base_Jump_All.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS3_Base_Jump_1.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS3_Base_Jump_2.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS3_Base_Jump_3.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS3_Base_Unsatisfied_Demand.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS3_Base_Excess_Demand.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS3_Base_Excess_Demand_All.pdf", width = 8, height = 6, units = "in")
