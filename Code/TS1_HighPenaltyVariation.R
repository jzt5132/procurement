...
ggsave("TS1_HighPenaltyVariation_Candle.pdf", width = 11.69, height = 8.27, units = "in")
...
ggsave("TS1_HighPenaltyVariation_Encounter.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_HighPenaltyVariation_Jump_All.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_HighPenaltyVariation_Jump_1.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_HighPenaltyVariation_Jump_2.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_HighPenaltyVariation_Jump_3.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_HighPenaltyVariation_Unsatisfied_Demand.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_HighPenaltyVariation_Excess_Demand.pdf", width = 8, height = 6, units = "in")
...
ggsave("TS1_HighPenaltyVariation_Excess_Demand_All.pdf", width = 8, height = 6, units = "in")
