...
for (loop in 1:N_){
  ...
  S_org = rnorm(K_, supply_seed[loop], 1)
  
  S_7 = rnorm(6, 0.8 * supply_seed[loop], 0.5)
  S_2 = rnorm(3, 1.30* supply_seed[loop], 1.5)
  S_1 = sum(S_org) - sum(S_2) - sum(S_7)
...
#ggsave("TS1_HighConcentration_Candle.pdf", width = 11.69, height = 8.27, units = "in")
...
#ggsave("TS1_HighConcentration_Encounter.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_HighConcentration_Jump_All.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_HighConcentration_Jump_1.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_HighConcentration_Jump_2.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_HighConcentration_Jump_3.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_HighConcentration_Unsatisfied_Demand.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_HighConcentration_Excess_Demand.pdf", width = 8, height = 6, units = "in")
...
#ggsave("TS1_HighConcentration_Excess_Demand_All.pdf", width = 8, height = 6, units = "in")
